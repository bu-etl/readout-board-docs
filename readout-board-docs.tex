...
The differences in assumptions between the two calculations are:
  ...
  \begin{tabular}{llll}
    ...
    Solder bump conductivity    & 70            & 60              & W/m$\dot$K    \\
    Solder bump height          & 100           & 150             & $\upmu$m      \\
    Silicon sensor conductivity & 150           & 191             & W/m$\dot$K    \\
    Silicon sensor thickness    & 300           & 200             & $\upmu$m      \\
    Epoxy conductivity          & 0.22          & 1.33            & W/m$\dot$K    \\
    Epoxy thickness             & 500           & 1000            & $\upmu$m      \\
    AlN conductivity            & 160           & 200             & W/m$\dot$K    \\
  \end{tabular}
  \end{center}
